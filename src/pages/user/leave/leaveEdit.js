...
const leaveEdit = (container, id) => {
  ...
  leaveEditRender.className = "container-wrap";
      ...
      const modal = Modal({
        ...
        onConfirm: () => {
          ...
          if (index !== -1) {
            ...
            window.location.href = `/leave/${id}`; // 수정된 페이지로 리다이렉트
          } else {
  ...
  <div class="content-wrap leave-edit">
...
`;
  ...
  if (leaveItem) {
    ...
    document.getElementById("halfday-type").value = leaveItem.halfDayTypeId || "-";
